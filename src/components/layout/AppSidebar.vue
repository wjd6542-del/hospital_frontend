...
.item { display: flex; align-items: center; gap: 0.7rem; padding: 0.55rem 0.7rem; color: var(--text-muted); font-size: 0.86rem; font-weight: 600; text-decoration: none; position: relative; transition: background 0.12s, color 0.12s; cursor: pointer; border: 1px solid transparent; border-radius: 6px; }
...
.item.on { background: var(--accent-soft); color: var(--accent); border-color: transparent; }
...
.child { display: flex; align-items: center; gap: 0.5rem; padding: 0.42rem 0.6rem; border-radius: 6px; font-size: 0.82rem; color: var(--text-subtle); text-decoration: none; transition: background 0.12s, color 0.12s; }
...
.foot { position: relative; z-index: 1; padding: 0.8rem 1rem; font-family: var(--font-sans); font-size: 0.62rem; letter-spacing: 0.08em; color: var(--text-subtle); border-top: 1px solid var(--border); }
