...
.tgl {
  ...
  border: 2px solid var(--border-strong); border-radius: 3px; background: var(--surface-2);
...
.tgl:hover { transform: translate(-1px, -1px); box-shadow: 3px 3px 0 var(--border-strong); }
.tgl:active { transform: translate(1px, 1px); box-shadow: 1px 1px 0 var(--border-strong); }
...
.tgl.dis:hover, .tgl.dis:active { transform: none; box-shadow: 2px 2px 0 var(--border-strong); }
</style>
