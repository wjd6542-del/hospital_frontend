...
.row { display: flex; align-items: center; gap: 0.8rem; padding: 0.8rem 1rem; background: var(--surface); border: 2px solid var(--border-strong); border-radius: 4px; flex-wrap: wrap; }
.order { display: flex; flex-direction: column; gap: 3px; }
.ord { width: 26px; height: 18px; display: flex; align-items: center; justify-content: center; border-radius: 3px; font-size: 0.66rem; color: var(--text); background: var(--surface); border: 2px solid var(--border-strong); box-shadow: 2px 2px 0 var(--border-strong); transition: all 0.075s; }
.ord:hover:not(:disabled) { color: var(--accent); transform: translate(-1px, -1px); box-shadow: 3px 3px 0 var(--border-strong); }
.ord:active:not(:disabled) { transform: translate(1px, 1px); box-shadow: 1px 1px 0 var(--border-strong); }
...
.off { font-size: 0.68rem; color: var(--text-subtle); background: var(--border); padding: 0.05rem 0.4rem; border-radius: 3px; }
.rtags { display: flex; gap: 0.3rem; flex-wrap: wrap; }
.tag { font-size: 0.68rem; font-weight: 700; color: var(--text-muted); background: var(--border); padding: 0.1rem 0.5rem; border-radius: 3px; }
...
.panel { width: 480px; max-width: 100%; background: var(--surface); border: 2px solid var(--border-strong); border-radius: 4px; padding: 1.4rem; }
...
.chk input { appearance: none; -webkit-appearance: none; flex-shrink: 0; width: 18px; height: 18px; border: 2px solid var(--border-strong); border-radius: 3px; background: var(--surface); box-shadow: 2px 2px 0 var(--border-strong); cursor: pointer; position: relative; transition: all 0.075s; }
...
.chk input:active { transform: translate(1px, 1px); box-shadow: 1px 1px 0 var(--border-strong); }
