...
.ttl { font-family: var(--font-sans); font-size: 1.5rem; font-weight: 700; color: var(--text); margin-top: 0.4rem; }
.pin { font-size: 0.7rem; color: var(--accent); background: var(--accent-soft); padding: 0.1rem 0.45rem; border-radius: 3px; margin-right: 0.5rem; vertical-align: middle; }
...
.prose :deep(h2) { font-family: var(--font-sans); font-size: 1.3rem; font-weight: 700; margin: 1rem 0 0.4rem; color: var(--text); }
...
.gitem { display: block; border-radius: 3px; overflow: hidden; border: 2px solid var(--border-strong); }
...
.file { font-size: 0.85rem; color: var(--text-muted); text-decoration: none; padding: 0.5rem 0.7rem; background: var(--surface); border: 2px solid var(--border-strong); border-radius: 3px; }
...
.ch { font-family: var(--font-sans); font-weight: 700; color: var(--text); margin-bottom: 0.9rem; }
.clist { display: flex; flex-direction: column; gap: 0.9rem; margin-bottom: 1.1rem; }
.citem { background: var(--surface); border: 2px solid var(--border-strong); border-radius: 3px; padding: 0.7rem 0.85rem; }
...
.cwrite textarea { flex: 1; padding: 0.6rem 0.7rem; font-size: 0.9rem; border: 2px solid var(--border-strong); border-radius: 3px; outline: none; resize: vertical; background: var(--surface); }
